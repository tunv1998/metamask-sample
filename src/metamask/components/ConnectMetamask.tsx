...
const ConnectMetamask = () => {
  const { getUserInfo, isConnecting } = useMetamask();
  if (!window.ethereum) {
    return (
      <>
        ...
        <a
          ...
          target="_blank"
        >
          <button className="my-2 bg-blue-500 text-white px-5 py-3 rounded-md my-2 font-bold tracking-wider text-center hover:cursor-pointer uppercase">
            Install Metamask
          </button>
        </a>
      </>
